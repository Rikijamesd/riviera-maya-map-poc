...
// bedroom/bathroom counts, and availability counts are FABRICATED for demo
// purposes only — real per-unit data would come from parsing the monthly
// developer PDFs (see README "Next steps").
...
const DEVELOPMENTS = [
  {
    ...
    units: [
      ...
      { type: "1BR", bedrooms: 1, bathrooms: 1, price: 168000, size: 58, available: 6 },
      { type: "2BR", bedrooms: 2, bathrooms: 2, price: 245000, size: 88, available: 3 },
    ],
  },
  {
    id: 2,
    ...
    units: [
      ...
      { type: "2BR", bedrooms: 2, bathrooms: 2, price: 289000, size: 95, available: 5 },
      { type: "3BR", bedrooms: 3, bathrooms: 3, price: 410000, size: 140, available: 1 },
    ],
  },
  {
    id: 3,
    ...
    units: [
      ...
      { type: "1BR", bedrooms: 1, bathrooms: 1, price: 132000, size: 52, available: 10 },
      { type: "2BR", bedrooms: 2, bathrooms: 2, price: 189000, size: 78, available: 6 },
    ],
  },
  {
    id: 4,
    ...
    units: [
      ...
      { type: "2BR", bedrooms: 2, bathrooms: 2, price: 210000, size: 84, available: 4 },
    ],
  },
  {
    id: 5,
    ...
    units: [
      ...
      { type: "2BR", bedrooms: 2, bathrooms: 2, price: 265000, size: 92, available: 2 },
    ],
  },
  {
    id: 6,
    ...
    units: [
      ...
      { type: "1BR", bedrooms: 1, bathrooms: 1.5, price: 225000, size: 64, available: 7 },
      { type: "2BR", bedrooms: 2, bathrooms: 2, price: 340000, size: 98, available: 3 },
    ],
  },
  {
    id: 7,
    ...
    units: [
      ...
      { type: "2BR", bedrooms: 2, bathrooms: 2, price: 315000, size: 90, available: 2 },
    ],
  },
  {
    id: 8,
    ...
    units: [
      ...
      { type: "3BR", bedrooms: 3, bathrooms: 3, price: 560000, size: 155, available: 1 },
    ],
  },
  {
    id: 9,
    ...
    units: [
      ...
      { type: "1BR", bedrooms: 1, bathrooms: 1.5, price: 260000, size: 68, available: 5 },
      { type: "2BR", bedrooms: 2, bathrooms: 2.5, price: 420000, size: 105, available: 2 },
    ],
  },
  {
    id: 10,
    ...
    units: [
      ...
      { type: "1BR", bedrooms: 1, bathrooms: 1, price: 205000, size: 59, available: 6 },
      { type: "3BR", bedrooms: 3, bathrooms: 2.5, price: 495000, size: 148, available: 1 },
    ],
  },
  {
    id: 11,
    ...
    units: [
      ...
      { type: "1BR", bedrooms: 1, bathrooms: 1, price: 110000, size: 50, available: 8 },
    ],
  },
  {
    id: 12,
    ...
    units: [
      ...
      { type: "2BR", bedrooms: 2, bathrooms: 2, price: 365000, size: 96, available: 3 },
    ],
  },
  {
    id: 13,
    ...
    units: [
      ...
      { type: "2BR", bedrooms: 2, bathrooms: 2, price: 220000, size: 82, available: 3 },
    ],
  },
  {
    id: 14,
    ...
    units: [
      ...
      { type: "2BR", bedrooms: 2, bathrooms: 2, price: 355000, size: 97, available: 4 },
      { type: "3BR", bedrooms: 3, bathrooms: 2.5, price: 520000, size: 145, available: 2 },
    ],
  },
];
